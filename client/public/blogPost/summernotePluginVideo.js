  ...
  var showVideoDialog = function ($editable, $dialog, text) {
    return $.Deferred(function (deferred) {
      ...
      var $videoUrl = $videoDialog.find('.note-video-url'),
          ...
          $copyURL =  $videoDialog.find('.copyURL');


      $('img').attr('src', Session.get('copyURL'));
      ...
      $videoDialog.one('shown.bs.modal', function () {
        ...
        $copyURL.click(function(event) {
          ...
          $videoUrl.val(Session.get("copyURL"));
          toggleBtn($videoBtn, $videoUrl.val());
        });
    ...
    */
    dialogs: {
      video: function (lang) {
        var body = '<div class="form-group row-fluid">' +
            ...
            ' <i class="copyURL fa fa-clipboard fa-lg"></i>'
            +
    ...
    langs: {
      'en-US': {
        video: {
          video: 'Picture',
          videoLink: 'Picture Link',
          insert: 'Insert Picture',
          url: 'Picture URL?',
          providers: '(Click icon ->)'
        }
      },
      'ar-AR': {
        video: {
